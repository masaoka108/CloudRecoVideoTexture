...
public class VideoPlayerHelper
{
    ...
    {
		Debug.Log ("VideoPlayerHelper Init");
		Debug.Log (rendererAPI);
...
>>>>>>> develop
    ...
    private bool videoPlayerInit(VuforiaRenderer.RendererAPI rendererAPI)
    {
		Debug.Log("Unity videoPlayerInit");
    ...
    private bool videoPlayerPlay(bool fullScreen, float seekPosition)
    {
        Debug.Log("mVideoPlayerPtr:" + mVideoPlayerPtr);
        Debug.Log("fullScreen:" + fullScreen);
        Debug.Log("seekPosition:" + seekPosition);

	//ここでVideoPlayerWrapper.mm のvideoPlayerPlayIOSにアクセス
